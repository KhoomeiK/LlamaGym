...
def batchify_episode(messages, reward):
    ...
    rewards = [torch.tensor(per_turn_reward)] * len(queries)
...
if __name__ == "__main__":
    ...
    for episode in trange(10):
        episode_messages = [
            {
                "role": "system",
                "content": """You are an expert single-player blackjack player. Every turn, you'll see your current sum, the dealer's showing card value, and whether you have a usable ace. You win by (1) not exceeding 21, and (2) exceeding the dealer's hand -- hidden+showing card values.
